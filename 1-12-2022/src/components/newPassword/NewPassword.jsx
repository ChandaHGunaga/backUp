...
const NewPassword = () => {
  const formik = useFormik({
    ...
    validationSchema:Yup.object({
     Npassword:Yup.string().min(8, 'Password must be 8 characters long')
     .matches(/[0-9]/, 'Password requires a number')
     .matches(/[a-z]/, 'Password requires a lowercase letter')
     .matches(/[A-Z]/, 'Password requires an uppercase letter')
     .required("Please enter your password"),
     Cpassword:Yup.string().oneOf([Yup.ref("Npassword"),null],"Password must match").required("Required*"),
  ...
  return (
    <div>
      ...
      >
        ...
        {formik.errors.Npassword ? <p className="error-msg">{formik.errors.Npassword}</p>:null}
        <input
          type="password"
          id="Cpassword"
          name="Cpassword"
        ...
        {formik.errors.Cpassword ? <p className="error-msg">{formik.errors.Cpassword}</p>:null}
